...
of variances.)");
  ...
  bind_structured_creation<Eigen::Affine3d, double, 4, 4>(m, "affine_transforms");
  bind_structured_creation<scipp::core::Quaternion, double, 4>(m, "rotations");
  bind_structured_creation<scipp::core::Translation, double, 3>(m, "translations");

  using structured_t = std::tuple<Eigen::Vector3d, Eigen::Matrix3d, Eigen::Affine3d, scipp::core::Quaternion, scipp::core::Translation>;
