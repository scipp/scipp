...
template <> inline constexpr DType dtype<std::span<const uint64_t>>{104};
template <> inline constexpr DType dtype<std::span<const bool>>{105};
template <> inline constexpr DType dtype<std::span<const std::string>>{106};
template <> inline constexpr DType dtype<std::span<const time_point>>{107};
...
template <> inline constexpr DType dtype<std::span<uint64_t>>{204};
template <> inline constexpr DType dtype<std::span<bool>>{205};
template <> inline constexpr DType dtype<std::span<std::string>>{206};
template <> inline constexpr DType dtype<std::span<time_point>>{207};
