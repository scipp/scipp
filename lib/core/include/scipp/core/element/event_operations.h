...
constexpr auto map = overloaded{
    element::arg_list<map_detail::args<int64_t, int64_t, double>,
                      ...
                      map_detail::args<int64_t, int64_t, Eigen::Vector3d>,
                      ...
                      map_detail::args<int32_t, int32_t, Eigen::Vector3d>,
                      ...
                      map_detail::args<int64_t, double, Eigen::Vector3d>,
                      ...
                      map_detail::args<int32_t, double, Eigen::Vector3d>,
                      ...
                      map_detail::args<double, double, Eigen::Vector3d>,
                      ...
                      map_detail::args<float, double, Eigen::Vector3d>,
                      ...
                      map_detail::args<float, float, Eigen::Vector3d>,
                      ...
                      map_detail::args<double, float, Eigen::Vector3d>>,
