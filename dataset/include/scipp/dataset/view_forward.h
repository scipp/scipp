...
using CoordsConstView = ConstView<ViewId::Coords, Dim, core::Variable>;
...
using AttrsConstView = ConstView<ViewId::Attrs, std::string, core::Variable>;
...
using MasksConstView = ConstView<ViewId::Masks, std::string, core::Variable>;
