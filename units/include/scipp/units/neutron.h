...
template <> struct supported_units<neutron::Unit> {
  using type = decltype(detail::make_unit(
      ...
      std::make_tuple(dimensionless, rad, deg, rad / deg, deg / rad, counts, s,
                      kg, angstrom, meV, us, dimensionless / us,
                      dimensionless / s, counts / us, counts / angstrom,
                      ...
                      us *us, dimensionless / (us * us), dimensionless / meV)));
};
