...
from .core import scalar, zeros, zeros_like, ones, ones_like, empty, empty_like, full, \
    full_like, matrix, matrices, vector, vectors, array, linspace, geomspace, logspace, \
    arange
