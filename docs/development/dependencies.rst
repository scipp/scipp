...
- `pixi.toml <https://github.com/scipp/scipp/blob/main/pixi.toml>`_ defines all development, CI, and build dependencies.
  ``pixi.lock`` pins resolved versions.
  Run ``pixi install`` to update the lock file after changing ``pixi.toml``.
