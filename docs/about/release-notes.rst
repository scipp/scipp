...
* ``astype`` and ``to_unit`` now copy the input by default even when no transformation is required, use the new ``copy`` argument to avoid `#20016 <https://github.com/scipp/scipp/pull/20016>`_.
