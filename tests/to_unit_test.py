...
def test_datetime64_with_explicit_ns_unit_is_consistent_irrespective_of_decimals(year):
    assert sc.identical(sc.datetime(f'{year}-01-01T12:00:00', unit='ms'),
                        sc.datetime(f'{year}-01-01T12:00:00.000', unit='ms'))
    assert sc.identical(sc.datetime(f'{year}-01-01T12:00:00', unit='us'),
                        sc.datetime(f'{year}-01-01T12:00:00.000000', unit='us'))
