...
template <class T>
void declare_events_container(py::module &m, const std::string &suffix) {
...
void init_events_container(py::module &m) {
  declare_events_container<double>(m, "float64");
  declare_events_container<float>(m, "float32");
  declare_events_container<int64_t>(m, "int64");
  declare_events_container<int32_t>(m, "int32");
}
