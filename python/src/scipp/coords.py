...
def transform_coords(x: Union[DataArray, Dataset],
                     ...
                     graph: Dict[str, Union[str, Callable]],
                     *,
                     rename_dims=True,
    ...
    :param graph: A graph defining how new coords can be computed from existing
                  ...
                  - Dict keys are `str`, defining the name of coords generated
                    by a dict value.
                  - Dict values are `str` or a callable (function). If `str`,
                    ...
                    variables. If a dict, multiple graph dict entries can refer
                    to the same function but extract a different return value.
