...
def dispatch(input_data, ndim=0, name=None, collapse=None, sparse_dim=None,
             bins=None, projection=None, color=None, marker=None, linestyle=None, linewidth=None,  **kwargs):
    """
    ...
    if sparse_dim is not None and bins is None:
        ...
        return plot_1d(input_data, color=color, marker=marker, linewidth=linewidth, linestyle=linestyle, **kwargs)
    elif projection == "2d":
