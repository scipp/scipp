...
public:
  Docstring() = default;
  Docstring(const std::string description, const std::string raises,
  ...
  const std::string to_string(const std::string rtype) const;

private:
  std::string m_description, m_raises, m_seealso, m_returns;
