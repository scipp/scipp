import unittest
    ...
    from dataset import * import numpy as np import matplotlib.pyplot as plt

    class TestDataset(unittest.TestCase) : def setUp(self) : lx = 2 ly = 3 lz = 4 self.reference_x = np.arange(lx) self.reference_y = np.arange(ly) self.reference_z = np.arange(lz) self.reference_data1 = np.arange(lx * ly * lz).reshape(lz, ly, lx) self.reference_data2 = np.ones(lx * ly * lz).reshape(lz, ly, lx) self.reference_data3 = np.arange(lx * lz).reshape(lz, lx)

                                                                                                                                                                                                                                                                                                                                                                                   self.dataset = Dataset() self.dataset[Data.Value, "data1"] =([Dim.Z, Dim.Y, Dim.X], self.reference_data1) self.dataset[Data.Value, "data2"] =([Dim.Z, Dim.Y, Dim.X], self.reference_data2) self.dataset[Data.Value, "data3"] =([Dim.Z, Dim.X], self.reference_data3) self.dataset[Coord.X] =([Dim.X], self.reference_x) self.dataset[Coord.Y] =([Dim.Y], self.reference_y) self.dataset[Coord.Z] =([Dim.Z], self.reference_z)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   def test_size(self) :
#X, Y, Z, 3 x Data::Value
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 self.assertEqual(len(self.dataset), 6)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      def test_repr(self) : serialized_ds = repr(self.dataset) self.assertTrue(len(serialized_ds)> 0) expected = "Dataset with 6 variables\nDimensions : {{Dim.X, 2}, {Dim.Y, 3}, {Dim.Z, 4}}\nCoordVariable(Coord.X, )\nCoordVariable(Coord.Y, )\nCoordVariable(Coord.Z, )\nDataVariable(Data.Value, data1)\nDataVariable(Data.Value, data2)\nDataVariable(Data.Value, data3)" self.assertEqual(serialized_ds, expected)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     def test_contains(self) : self.assertTrue(Coord.X in self.dataset) self.assertTrue(Coord.Y in self.dataset) self.assertTrue(Coord.Z in self.dataset) self.assertTrue((Data.Value, "data1") in self.dataset) self.assertTrue((Data.Value, "data2") in self.dataset) self.assertTrue((Data.Value, "data3") in self.dataset) self.assertFalse((Data.Value, "data4") in self.dataset)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     def test_view_contains(self) : view = self.dataset["data2"] self.assertTrue(Coord.X in view) self.assertTrue(Coord.Y in view) self.assertTrue(Coord.Z in view) self.assertFalse((Data.Value, "data1") in view) self.assertTrue((Data.Value, "data2") in view) self.assertFalse((Data.Value, "data3") in view) self.assertFalse((Data.Value, "data4") in view)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        def test_delitem(self) : dataset = Dataset() dataset[Data.Value, "data"] =([Dim.Z, Dim.Y, Dim.X], (1, 2, 3)) dataset[Data.Value, "aux"] =([], ()) self.assertTrue((Data.Value, "data") in dataset) self.assertEqual(len(dataset.dimensions()), 3) del dataset[Data.Value, "data"] self.assertFalse((Data.Value, "data") in dataset) self.assertEqual(len(dataset.dimensions()), 0)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     dataset[Data.Value, "data"] =([Dim.Z, Dim.Y, Dim.X], (1, 2, 3)) dataset[Coord.X] =([Dim.X], np.arange(3)) del dataset[Data.Value, "data"] self.assertFalse((Data.Value, "data") in dataset) self.assertEqual(len(dataset.dimensions()), 1) del dataset[Coord.X] self.assertFalse(Coord.X in dataset) self.assertEqual(len(dataset.dimensions()), 0)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   def test_insert_default_init(self) : d = Dataset() d[Data.Value, "data1"] =((Dim.Z, Dim.Y, Dim.X), (4, 3, 2)) self.assertEqual(len(d), 1) np.testing.assert_array_equal(d[Data.Value, "data1"].numpy, np.zeros(shape =(4, 3, 2)))

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             def test_insert(self) : d = Dataset() d[Data.Value, "data1"] =([Dim.Z, Dim.Y, Dim.X], np.arange(24).reshape(4, 3, 2)) self.assertEqual(len(d), 1) np.testing.assert_array_equal(d[Data.Value, "data1"].numpy, self.reference_data1)

#Currently implicitly replacing keys in Dataset is not supported.Should it ?
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               self.assertRaisesRegex(RuntimeError, "Attempt to insert data with duplicate tag and name.", d.__setitem__, (Data.Value, "data1"), ([Dim.Z, Dim.Y, Dim.X], np.arange(24).reshape(4, 3, 2)))

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       self.assertRaisesRegex(RuntimeError, "Cannot insert variable into Dataset: Dimensions do not match.", d.__setitem__, (Data.Value, "data2"), ([Dim.Z, Dim.Y, Dim.X], np.arange(24).reshape(4, 2, 3)))

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               def test_insert_variable(self) : d = Dataset() d[Data.Value, "data1"] =([Dim.Z, Dim.Y, Dim.X], np.arange(24).reshape(4, 3, 2))

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            var = Variable(Data.Value, [Dim.X], np.arange(2)) d[Data.Value, "data2"] = var d[Data.Variance, "data2"] = var self.assertEqual(len(d), 3)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                def test_insert_variable_slice(self) : d = Dataset() d[Data.Value, "data1"] =([Dim.Z, Dim.Y, Dim.X], np.arange(24).reshape(4, 3, 2))

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   d[Data.Value, "data2"] = d[Data.Value, "data1"] d[Data.Variance, "data2"] = d[Data.Value, "data1"] self.assertEqual(len(d), 3)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           def test_set_data(self) : d = Dataset() d[Data.Value, "data1"] =([Dim.Z, Dim.Y, Dim.X], np.arange(24).reshape(4, 3, 2)) self.assertEqual(d[Data.Value, "data1"].numpy.dtype, np.int64) d[Data.Value, "data1"] = np.arange(24).reshape(4, 3, 2) self.assertEqual(d[Data.Value, "data1"].numpy.dtype, np.int64)
#For existing items we do * not*change the dtype, but convert.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   d[Data.Value, "data1"] = np.arange(24.0).reshape(4, 3, 2) self.assertEqual(d[Data.Value, "data1"].numpy.dtype, np.int64)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      def test_set_data_nested(self) : d = Dataset() table = Dataset() table[Data.Value, "col1"] =([Dim.Row], [3.0, 2.0, 1.0, 0.0]) table[Data.Value, "col2"] =([Dim.Row], np.arange(4.0)) d[Data.Value, "data1"] =([Dim.X], [table, table]) d[Data.Value, "data1"].data[1][Data.Value, "col1"].data[0] = 0.0;
...
#representation is of course supported,                                        \
    this is just to demonstrate the flexibility)
