...
def test_create_variable_0D_vector_3_float64_from_list():
...
def test_create_variable_0D_vector_3_float64_from_numpy():
...
def test_create_variable_1D_vector_3_float64_from_list():
...
def test_create_variable_1D_vector_3_float64_from_numpy():
    var = sc.Variable(dims=['x'],
...
def test_create_quaternion_float64_from_list():
...
def test_create_quaternion_float64_from_numpy():
